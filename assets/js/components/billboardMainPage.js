...
export const billboardMainPage = (billboard) => {
    ...
    [
        ...
        {adImg: "assets/resources/images/imgs/billboard/billboard-2.jpg", adLink:"#tienda", adAlt: "imagen-promociones-2"},
        ...
        {adImg: "assets/resources/images/imgs/billboard/billboard-5.png", adLink:"#tienda", adAlt: "imagen-promociones-5"}
    ]

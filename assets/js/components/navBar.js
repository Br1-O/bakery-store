...
<nav class="navbar navbar-expand-lg bg-body-tertiary w-100 h-auto fixed-top z-index-5 d-flex flex-row justify-content-between align-items-center bg-glass-effect smooth-transition">
    <div class="container-fluid">
       <a id="logoMenu" aria-label="Logo de la pagina" class="navbar-brand w-25" href="#"> 
        ...
        <ul class="navbar-nav m-auto mb-2 mb-lg-0 d-flex flex-row justify-content-around align-items-center p-2 w-65">
        
                <li class="nav-item">
                    <a aria-label="home" class="nav-link" href="#home">Home</a>
                </li>
                <li class="nav-item">
                    <a aria-label="bakery" class="nav-link" href="#bakery"> Bakery </a>
                </li>
